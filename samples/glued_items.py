...
class Scene(QGraphicsScene):
    def __init__(self, parent=None):
        ...
        self._insert_marker.setSharedRenderer(QSvgRenderer(QByteArray() \
            .append(QString(INSERT_MARKER))))
...
class GraphicsBlock(QGraphicsPixmapItem):
    def __init__(self, function_name, svg_data, parent=None, scene=None):
        super(GraphicsBlock, self).__init__(parent, scene)
        ...
        self._initPixmap(svg_data)

    def _initPixmap(self, svg_data):

        self.svg_renderer = QSvgRenderer(QByteArray().append(
            QString(svg_data.replace("@BLOCK_NAME@", self.function_name))))

        self.pix = QPixmap(self.svg_renderer.defaultSize())
        self.pix.fill(Qt.transparent)

        self.svg_renderer.render(QPainter(self.pix),
                                 QRectF(self.svg_renderer.viewBox()))

        self.setPixmap(self.pix)

    def paint(self, painter, option, widget=None):
        #super(GraphicsBlock, self).paint(painter, option, widget)
...
if __name__ == "__main__":
    ...
    block_digital_write = GraphicsBlock("digitalWrite", BLOCK_SVG, None, scene)
